      ...
      >
        <div class="sm:flex sm:items-start">
          <button
            ...
            class="flex items-center justify-center flex-shrink-0 w-12 h-12 mx-auto bg-green-100 rounded-full cursor-none sm:mx-0 sm:h-10 sm:w-10"
          >
            <svg
          ...
          <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
            ...
            <div class="mt-2">
              <p class="text-sm text-gray-500">
                So, you've decided to break up with us? Are you sure? Think of
                all the good times we've had... like that one time you forgot
                your password and we sent you that super secure reset email. 😅
                <br /><br />
                Warning: Deactivating your account means saying goodbye to all your
                data. It's like sending your photos and messages on a one-way trip
                to the Bermuda Triangle – they're gone forever! 🌊📸
                <br /><br />
                This action is more permanent than your childhood crush's love for
                1st PC. 🤷‍♂️ Are you really, really, REALLY sure you want to do this?
