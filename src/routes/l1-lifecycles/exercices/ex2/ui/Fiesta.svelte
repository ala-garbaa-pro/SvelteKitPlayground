      ...
      >
        <div class="sm:flex sm:items-start">
          <button
            ...
            class="cursor-none mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-yellow-100 sm:mx-0 sm:h-10 sm:w-10"
          >
            <svg
          ...
          <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
            ...
            <div class="mt-2">
              <p class="text-sm text-gray-500">
                So, you've decided to part ways with us? Are you absolutely
                certain? Let's reminisce about the beautiful moments we've
                shared, like the time you forgot your password, and we swooped
                in with that super secure reset email, a digital knight in
                shining armor. 💖

                <br /> Warning: Deactivating your account is like bidding adieu
                to the digital diary of our love story. It's akin to sending our
                shared photos and messages on a one-way journey into the digital
                ether, a love letter lost in cyberspace. 💌💔

                <br /> This decision is more heart-wrenching than the bittersweet
                memories of your first crush's shy smile. 🌹 Are you truly, deeply,
                romantically sure you want to take this step? There's no turning
                back, and a digital void may echo the silence of our connection.
                💔💔
              </p>
            </div>
          </div>
