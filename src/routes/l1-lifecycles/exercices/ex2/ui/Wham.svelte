          ...
          <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
            ...
            <div class="mt-2">
              <p class="text-sm text-gray-500">
                So, you've chosen to say goodbye to us? Are you certain? Reflect
                on the moments we shared, like the time you struggled with your
                password, and we rescued you with that super secure reset email.
                😢

                <br /> Warning: Deactivating your account is like bidding
                farewell to all your cherished memories. It's akin to watching
                your photos and messages embark on an irreversible journey into
                the abyss, lost forever! 🌊📸
                <br /> This decision is sadder than the fading echoes of your childhood
                crush's affection for their first PC. 🥀 Are you truly, deeply, heartbreakingly
                sure you want to go through with this? There's no turning back, and
                the shadows of regret may linger. 😔
              </p>
            </div>
          </div>
        </div>
